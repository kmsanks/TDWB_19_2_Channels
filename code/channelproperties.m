...
% Make sure data is normally distributed (are there outliers?)- yes so
% above we crop dzd data to something reasonable
% figure()
...
tmphc18 = rmoutliers(Hc_all18);
tmphc19 = rmoutliers(Hc_all19);
