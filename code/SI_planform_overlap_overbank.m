...
for i = 1:size(flowscreen_18_mat,3)
    ...
    chanA = nansum(nansum(chanMaps_18_crop(:,:,i)));
    overA = wetA-chanA;
    dryA = A_18-overA;
    wetA_18 = [wetA_18;overA];
...
for i = 1:size(flowscreen_19_mat,3)
    ...
    chanA = nansum(nansum(chanMaps_19_crop(:,:,i)));
    overA = wetA-chanA;
    dryA = A_19-overA;
    wetA_19 = [wetA_19;overA];
...
saveas(fig, 'overbank_planform_change.pdf')
